...
export default function Login() {
  ...
  return (
    <AuthShell>
      ...
      <p className="mt-1 text-sm text-ink-500">Access your organization's inspection portal.</p>
      ...
      <form onSubmit={onSubmit} className="mt-8 space-y-4">
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              type="password" required autoComplete="current-password" className="input pl-9"
              placeholder="••••••••"
              value={form.password}
      ...
      <div className="mt-6 space-y-2 text-center text-sm text-ink-500">
        <p>
          New teammate?{' '}
          <Link to="/signup" className="font-semibold text-brand-600 hover:underline">Join your organization</Link>
        </p>
        <p>
          Setting up a new company?{' '}
          <Link to="/register-org" className="font-semibold text-brand-600 hover:underline">Register an organization</Link>
        </p>
      </div>
    </AuthShell>
  )
